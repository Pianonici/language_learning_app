...
class Dictionary(object):
    ...
    def __init__(self, file_name):
        ...
        for line in lines:
            line_elements = line.split(', ') #.split(', ') returns a list in the form of ["German word", "(part of speech)", "English word"]
    ...
    #the values of _dictionary_part_of_speech_to_english are lists and random.choice gives us a random entry from that list
